...
These are all personal notes obtained from Google's Kotlin Bootcamp for Programmers Udacity Course (ud9011) as well as other resources. If you are a novice, you may use it to learn Kotlin; I have taken most of the stuff covered in all sections/videos of this course, as well as some small parts from official documentation and JetBrains videos. I was also concerned with the arrangement of the topics, so it begins with the basics and progresses to the more difficult ones from top to bottom. This is not official paperwork. You will most likely discover additional personal remarks and human errors:)
